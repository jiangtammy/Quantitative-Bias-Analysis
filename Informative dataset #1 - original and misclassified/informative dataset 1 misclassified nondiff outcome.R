...
#Non-differential outcome misclassification for simulated data to assess prediction accuracy
...
dat.nondiff.misc.outcome.func.result <- t(sapply(1:10000, dat.nondiff.misc.outcome.func, se=myse, sp=mysp)) 
