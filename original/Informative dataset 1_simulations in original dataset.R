#QBA of random forests in the simulated data without any misclassification - FOR PREDICTION ACCURACY
...
simulated.data.func.result <- t(sapply(1:500, simulated.data.func)) #Ran this 20 times (10000 simulations)

write.csv(simulated.data.func.result, col.names=F,
          paste0("results/dat_original_without_misclassification_", 
