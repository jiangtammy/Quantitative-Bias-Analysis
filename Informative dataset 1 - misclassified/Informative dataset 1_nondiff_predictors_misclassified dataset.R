#QBA random forests - non-differential misclassification of predictor for simulated data to assess prediction accuracy
...
dat.nondiff.misc.pred.func.result <- t(sapply(1:1000, dat.nondiff.misc.pred.func, se=myse,sp=mysp)) #Ran this 10x (10000 simulations total)

write.csv(dat.nondiff.misc.pred.func.result, col.names=F,
          paste0("results/dat_nondiff_misc_predictor_myse_", myse, "_mysp_", mysp, "_", 
