#QBA random forests - differential outcome misclassification for simulated data to assess prediction accuracy
...
dat.diff.misc.outcome.func.result <- t(sapply(1:1000, dat.diff.misc.outcome.func, se1=myse1, sp1=mysp1, se0=myse0, sp0=mysp0)) #Ran this 10x for 10000 simulations total

write.csv(dat.diff.misc.outcome.func.result, col.names=F,
          paste0("results/dat_diff_misc_outcome_myse1_", myse1, "_mysp1_", mysp1, "_myse0_", myse0, "_mysp0_", mysp0, "_", 
