...
#Bias adjustment for non-differential misclassification of predictors for dataset to assess prediction accuracy
...
dat.nondiff.cor.pred.func.result <- t(sapply(1:10000, dat.nondiff.cor.pred.func, se=myse, sp=mysp)) 
