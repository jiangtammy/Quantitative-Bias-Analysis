#QBA random forests - non-differential misclassification of outcome for dataset assessing prediction accuracy
...
dat.nondiff.cor.outcome.func.result <- t(sapply(1:500, dat.nondiff.cor.outcome.func, se=myse,sp=mysp))  #Ran this 20x (10000 simulations total)

write.csv(dat.nondiff.cor.outcome.func.result, #Took out: , colnames=F,
          paste0("results/dat_nondiff_cor_outcome_myse_", myse, "_mysp_", mysp, "_", 
